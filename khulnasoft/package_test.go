...
func createTestPackage(_ *testing.T, c *Client) error {
	...
	url := fmt.Sprintf("%s/api/packages/PackageOrg/generic/MyPackage/v1/file1.txt", os.Getenv("KHULNASOFT_SDK_TEST_URL"))
	...
	req.SetBasicAuth(os.Getenv("KHULNASOFT_SDK_TEST_USERNAME"), os.Getenv("KHULNASOFT_SDK_TEST_PASSWORD"))
