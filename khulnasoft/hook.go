...
// HookType represent all webhook types khulnasoft currently offer
...
const (
	...
	// HookTypeKhulnasoft webhook that khulnasoft understand
	HookTypeKhulnasoft HookType = "khulnasoft"
