...
// GlobalUISettings represent the global ui settings of a khulnasoft instance witch is exposed by API
...
// GlobalRepoSettings represent the global repository settings of a khulnasoft instance witch is exposed by API
