...
// The relevant notification will be returned as the first parameter when the Khulnasoft server is 1.16.0 or higher.
...
// The relevant notifications will only be returned as the first parameter when the Khulnasoft server is 1.16.0 or higher.
